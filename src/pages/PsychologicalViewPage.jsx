...
const FALLBACK = {
  videos: [
    ...
    {
      id: 'f3',
      youtube_id: 'RiM5a-vaNkg',
      title: 'Breaking Stigma: Mental Health Conversations',
      description: 'A frank discussion on why mental health stigma persists and how to dismantle it.',
      duration: '31:05',
      views: '20K views',
    },
  ],
          ...
          {items.map((video, i) => {
            ...
            return (
              <div
                ...
                onClick={() => {
                  if (!isCenter) {
                    // first click brings the card to center
                    setCurrent(i)
                  } else {
                    // second click (or click on already-centered card) opens YouTube
              ...
              >
                <div style={{ position:'relative', aspectRatio:'16/9', background:'#0a1628', overflow:'hidden' }}>
                  ...
                  {/* "Click to watch" hint on non-center hover */}
                  {!isCenter && isHov && (
                ...
                <div style={{ padding:'0.9rem' }}>
                  ...
                  {/* Tap-to-watch hint shown on center card */}
                  {isCenter && (
