const assessments = [
  { title: 'PHQ-9', desc: 'Depression screening — 9 questions', tag: 'FREE · 5 min' },
  { title: 'GAD-7', desc: 'Anxiety assessment tool', tag: 'FREE · 4 min' },
  { title: 'DASS-21', desc: 'Depression, Anxiety & Stress', tag: 'FREE · 8 min' },
  { title: 'Burnout Check', desc: 'Work-related stress analysis', tag: 'FREE · 6 min' },
]
  ...
  return (
    <section className="section assessment" id="assessments">
      <div>
        ...
        <button className="btn btn-white btn-lg">Start a Free Assessment →</button>
      </div>
