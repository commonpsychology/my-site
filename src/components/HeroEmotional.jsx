...
const HEART_CSS = `
  ...
  .map-fab-ping {
    ...
    z-index: 8999;
    animation: map-btn-ping 2.2s ease-out infinite;
    pointer-events: none;
  }
  .map-fab-label {
    position: fixed;
  ...
  .map-fab:hover ~ .map-fab-label,
  .map-fab-label.visible {
    opacity: 1;
...
// Change lat/lng and label to match your actual office address
const OFFICE = {
  lat: 27.7172,
  lng: 85.3240,
  label: 'Mindful Wellness Nepal',
  address: 'Thimi, Bhaktapur, Nepal',
  // Google Maps embed URL (dynamic, scrollable, full interactive map)
  embedUrl:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3532.0!2d85.3240!3d27.7172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjfCsDQzJzAyLjAiTiA4NcKwMTknMjYuNCJF!5e0!3m2!1sen!2snp!4v1700000000000!5m2!1sen!2snp',
  ...
  return (
    ...
    >
      <div className="map-popup">
        ...
        {/* ── Dynamic interactive map (Google Maps iframe) ── */}
        <iframe
    ...
    <div className="hb-visual-root">
      ...
      <svg className="hb-heart-svg" viewBox="0 0 200 185" width="300" height="278" style={{ position: 'relative', zIndex: 30 }}>
        ...
        <g clipPath="url(#hc-clip)" opacity="0.4">
          <polyline points="18,90 38,90 48,70 58,110 66,76 74,100 84,90 116,90 124,68 134,114 142,72 150,98 160,90 182,90" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="hb-ekg-strip" style={{ animationDuration: '2.4s' }} />
        </g>
      ...
      {[
        ...
        <div key={i} className="hb-drop-particle" style={{ left: d.left, top: d.top, width: d.size, height: d.size, background: 'radial-gradient(circle at 32% 32%, rgba(255,255,255,0.85), rgba(0,191,255,0.65))', animationDelay: d.delay, animationDuration: d.dur }} />
      ))}

      <svg viewBox="0 0 360 44" width="360" height="44" style={{ position: 'absolute', bottom: '13%', left: '50%', transform: 'translateX(-50%)', opacity: 0.45, zIndex: 7, pointerEvents: 'none' }}>
        <polyline points="0,22 30,22 42,8 56,36 66,10 76,30 88,22 180,22 194,6 208,38 218,8 230,32 242,22 360,22" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hb-ekg-strip" style={{ animationDuration: '2.4s', strokeDasharray: 520 }} />
      </svg>
      ...
      <div className="hb-stat-pill" style={{ top: '6%', left: '50%', transform: 'translateX(-50%)', background: 'rgba(255,255,255,0.92)', border: '1.5px solid rgba(0,123,168,0.3)', zIndex: 32 }}>
        <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.68rem', fontWeight: 800, color: '#007BA8', letterSpacing: '0.06em' }}>❤️  500+ families healed</span>
      </div>
      <div className="hb-stat-pill" style={{ bottom: '8%', right: '2%', background: 'rgba(255,255,255,0.92)', border: '1.5px solid rgba(0,123,168,0.3)', zIndex: 32 }}>
        <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.65rem', fontWeight: 800, color: '#007BA8' }}>4.9 ★ rated</span>
      </div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
          <div style={{ width: 44, height: 44, borderRadius: '50%', flexShrink: 0, background: 'rgba(184,213,200,0.25)', border: '1.5px solid rgba(184,213,200,0.45)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', transition: 'transform 0.3s ease', transform: hovered === 'parent' ? 'scale(1.15) rotate(-6deg)' : 'scale(1)' }}>🌿</div>
          <div>
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.05rem', color: '#d4f0e0', lineHeight: 1.15, fontWeight: 400 }}>I'm a Parent</div>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.58rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(184,213,200,0.6)', marginTop: '2px' }}>For families</div>
          </div>
        </div>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.72rem', color: 'rgba(212,240,224,0.82)', lineHeight: 1.6, margin: '0 0 12px', fontWeight: 400 }}>My child has changed. I don't know how to reach them.</p>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid rgba(184,213,200,0.22)', paddingTop: '10px' }}>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.62rem', fontWeight: 800, letterSpacing: '0.09em', textTransform: 'uppercase', color: hovered === 'parent' ? '#b8d5c8' : 'rgba(184,213,200,0.5)', transition: 'color 0.2s' }}>Free 15-min call</span>
          <div style={{ width: 22, height: 22, borderRadius: '50%', background: hovered === 'parent' ? 'rgba(184,213,200,0.35)' : 'rgba(184,213,200,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', color: '#b8d5c8', transition: 'background 0.2s' }}>→</div>
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
          <div style={{ width: 44, height: 44, borderRadius: '50%', flexShrink: 0, background: 'rgba(216,180,254,0.2)', border: '1.5px solid rgba(216,180,254,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', transition: 'transform 0.3s ease', transform: hovered === 'teen' ? 'scale(1.15) rotate(6deg)' : 'scale(1)' }}>✨</div>
          <div>
            <div style={{ fontFamily: 'var(--font-display)', fontSize: '1.05rem', color: '#ede9fe', lineHeight: 1.15, fontWeight: 400 }}>I'm a Teen</div>
            <div style={{ fontFamily: 'var(--font-body)', fontSize: '0.58rem', fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(216,180,254,0.6)', marginTop: '2px' }}>For adolescents</div>
          </div>
        </div>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.72rem', color: 'rgba(237,233,254,0.82)', lineHeight: 1.6, margin: '0 0 12px', fontWeight: 400 }}>I feel so much but can't explain it to anyone.</p>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid rgba(216,180,254,0.22)', paddingTop: '10px' }}>
          <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.62rem', fontWeight: 800, letterSpacing: '0.09em', textTransform: 'uppercase', color: hovered === 'teen' ? '#ddd6fe' : 'rgba(221,214,254,0.5)', transition: 'color 0.2s' }}>Someone who listens</span>
          <div style={{ width: 22, height: 22, borderRadius: '50%', background: hovered === 'teen' ? 'rgba(216,180,254,0.3)' : 'rgba(216,180,254,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.7rem', color: '#ddd6fe', transition: 'background 0.2s' }}>→</div>
        </div>
      </div>
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // Show label hint briefly on first mount
  ...
  return (
    <section className="hero">
      ...
      {/* Tooltip label */}
      <div className={`map-fab-label${labelVisible ? ' visible' : ''}`}>
        Find Our Office
      </div>
